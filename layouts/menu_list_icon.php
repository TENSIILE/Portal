<a href='/personal_office.php?create_request'>
    <li class='create_request'>
    
            <svg version="1.1" id="pencil" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                y="0px" width="459px" height="459px" viewBox="0 0 459 459" style="enable-background:new 0 0 459 459;"
                xml:space="preserve">
                <g>
                    <g id="create">
...
<a href="/personal_office.php?my_created_requests">
    <li class='my_created_requests'>
    
        <svg version="1.1" id="list-text" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="0 0 512.18 512.18" style="enable-background:new 0 0 512.18 512.18;"
            xml:space="preserve">
            <g>
                <g>
                    <path
